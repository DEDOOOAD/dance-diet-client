...
import { Image, Linking, Modal, NativeModules, Platform, ScrollView, StatusBar, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
        ...
        <Modal
          ...
          <View style={styles.fullscreenContainer}>
            ...
            <View
              ...
              style={[
                styles.fullscreenFloatingControls,
                { top: Math.max(insets.top, 12), right: Math.max(insets.right, 0) + 12 },
              ]}>
              <TouchableOpacity
                style={styles.fullscreenDismissButton}
                activeOpacity={0.85}
                onPress={() => {
                  setIsPlayerFullscreen(false);
                }}>
