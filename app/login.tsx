...
import { setCurrentUserUuid } from '@/services/current-user';
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const result = await signInWithGeneralServer({
        email: trimmedEmail,
      ...
      if (result.userId) {
        await setCurrentUserUuid(result.userId);
        console.log('[auth] saved current user uuid', result.userId);
      } else {
        console.warn('[auth] login succeeded but no userId was returned');
      }
